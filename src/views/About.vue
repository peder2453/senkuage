<template>
  ...
  <div class="simple">
    ...
    <div class="sim-content fiat">
      ...
      <img src="@/assets/about/right-block.png" alt="" class="right-block" />
    </div>
  </div>
  <div class="crypto">
...
.crypto {
  background-image: url("~@/assets/about/crypot-back.png");
...
.simple .conver {
  ...
  width: 80%;
  background: #ffffff;
  box-shadow: 0px 0px 90px 0px rgba(38, 102, 227, 0.14);
  border-radius: 20px;
  align-items: center;
  padding: 1rem;
  & > img {
